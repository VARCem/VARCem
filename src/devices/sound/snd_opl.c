 ...
 *
 * Version:	@(#)snd_opl.c	1.0.6	2019/04/25
 *
...
void opl2_init(opl_t *opl)
{
        ...
        timer_add(opl_timer_callback00, opl,
		  &opl->timers[0][0], &opl->timers_enable[0][0]);
        timer_add(opl_timer_callback01, opl,
		  &opl->timers[0][1], &opl->timers_enable[0][1]);
        timer_add(opl_timer_callback10, opl,
		  &opl->timers[1][0], &opl->timers_enable[1][0]);
        timer_add(opl_timer_callback11, opl,

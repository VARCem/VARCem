 ...
 *			or 0Dh [10Mb]. 
 *
 * Version:	@(#)m_xt_t1000.c	1.0.1	2018/03/05
 *
...
void t1000_configsys_loadnvr(void)
{
	FILE *f;
...
void t1000_emsboard_loadnvr(void)
{
	FILE *f;
...
void t1000_configsys_savenvr(void)
{
	FILE *f;
...
void t1000_emsboard_savenvr(void)
{
	FILE *f;
